package com.shenjing.dimension.dimension.view.spiner;
...
public class SpinerAdapter extends BaseAdapter {
    ...
    public View getView(int pos, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.item_customer_manager, null);
            viewHolder = new ViewHolder();
            viewHolder.mTextView = (TextView) convertView.findViewById(R.id.textShopName);
