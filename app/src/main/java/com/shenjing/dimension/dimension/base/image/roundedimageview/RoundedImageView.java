...
package com.shenjing.dimension.dimension.base.image.roundedimageview;
...
public class RoundedImageView extends ImageView {
	...
	public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.RoundedImageViewNew, defStyle, 0);
		...
		float cornerRadiusOverride = a.getDimensionPixelSize(
				R.styleable.RoundedImageViewNew_riv_new_corner_radius, -1);

		mCornerRadii[Corner.TOP_LEFT] = a.getDimensionPixelSize(
				R.styleable.RoundedImageViewNew_riv_corner_radius_top_left, -1);
		mCornerRadii[Corner.TOP_RIGHT] = a.getDimensionPixelSize(
				R.styleable.RoundedImageViewNew_riv_corner_radius_top_right, -1);
		mCornerRadii[Corner.BOTTOM_RIGHT] = a
				.getDimensionPixelSize(
						R.styleable.RoundedImageViewNew_riv_corner_radius_bottom_right,
						-1);
		mCornerRadii[Corner.BOTTOM_LEFT] = a.getDimensionPixelSize(
				R.styleable.RoundedImageViewNew_riv_corner_radius_bottom_left, -1);
		...
		mBorderWidth = a.getDimensionPixelSize(
				R.styleable.RoundedImageViewNew_riv_new_border_width, -1);
		if (mBorderWidth < 0) {
			mBorderWidth = DEFAULT_BORDER_WIDTH;
		}

		mBorderColor = a
				.getColorStateList(R.styleable.RoundedImageViewNew_riv_new_border_color);
		...
		mMutateBackground = a.getBoolean(
				R.styleable.RoundedImageViewNew_riv_new_mutate_background, false);
		mIsOval = a.getBoolean(R.styleable.RoundedImageViewNew_riv_new_oval, false);

		final int tileMode = a
				.getInt(R.styleable.RoundedImageViewNew_riv_new_tile_mode,
						TILE_MODE_UNDEFINED);
		...
		final int tileModeX = a.getInt(
				R.styleable.RoundedImageViewNew_riv_new_tile_mode_x,
				TILE_MODE_UNDEFINED);
		...
		final int tileModeY = a.getInt(
				R.styleable.RoundedImageViewNew_riv_new_tile_mode_y,
				TILE_MODE_UNDEFINED);
