...
public class ChangeDatePopwindow extends PopupWindow implements View.OnClickListener {
	...
	public ChangeDatePopwindow(final Context context) {
		...
		wvYear = (WheelView) view.findViewById(R.id.wv_select_left);
		wvMonth = (WheelView) view.findViewById(R.id.wv_select_middle);
		wvDay = (WheelView) view.findViewById(R.id.wv_select_right);
		btnSure = (TextView) view.findViewById(R.id.btn_cancel);
		btnCancel = (TextView) view.findViewById(R.id.btn_sure);
