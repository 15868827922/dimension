...
public final class PackerNg {
    ...
    public static synchronized String getMarket(Context context, String defaultValue) {
    ...
    public static synchronized MarketInfo getMarketInfo(Context context, String defaultValue) {
        return getMarketInternal(context, defaultValue);
    }

    private static MarketInfo getMarketInternal(Context context, String defaultValue) {
        String market;
        Exception error;
        try {
