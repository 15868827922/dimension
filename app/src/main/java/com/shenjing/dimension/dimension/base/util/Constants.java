...
public class Constants {
    ...
    public static final String WeixinAppId = "wx1ed915811af783d6";
    public static final String WeixinSecret = "b8b2efe12c5342f4ae5087cb570b7596";
    public static final String QQAppId = "1106824941";
    public static final String QQSecret = "SnjuuYlNTJbKsCXO";
    ...
    public static final String OSS_BucketName = "zhaijidi";
