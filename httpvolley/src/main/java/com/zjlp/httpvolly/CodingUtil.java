...
/**
 * @PackName chinese.chat.flowerfriends.utils
 * @FileName CodingUtil
...
public class CodingUtil {//ucAuthcode加密
    public static void main(String[] args) {
        String content = "http://192.168.191.1/cjytest2/1/common/test";
        String key = "cjy";
        String encodeResult = authcodeEncode(content, key); //加密
        long lStart = System.currentTimeMillis();
        String decodeResult = authcodeDecode(encodeResult, key); //解密
    ...
    public static String getMd5_32(String content) {
        try {
            MessageDigest md = MessageDigest.getInstance("MD5");
            md.update(content.getBytes());
            byte b[] = md.digest();
